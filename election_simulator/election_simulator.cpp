...

{
    ...
    do
    {
        ...
        cout << UNDERLINED_TEXT << COLOR_BLUE << "\n\n====> Welcome to the election simulator! <====" << COLOR_RESET << endl;
        do
        {
            cout << COLOR_CYAN << "\nEnter your vote (1,2,3,4-null,5-blank and 0 to stop): " << COLOR_RESET;
            cin >> vote;
            while (cin.fail() || vote < 0 || vote > 5)
            {
                ...
                cout << COLOR_RED << "Invalid vote! Must be a number from 0-5! Try again: " << COLOR_RESET;
                cin >> vote;
            }
            if (vote == 1)
            {
        ...
        if (total_votes == 0)
        {
            cout << COLOR_RED << "\nNo votes cast in this election!" << COLOR_RESET << endl;
        }
        else
        {
        ...
        cout << COLOR_BLUE << "\n\nWould you like to simualte another election? (Y/N) " << COLOR_RESET;
        cin >> answer;
